...
{
    public class Player3DInstaller: InstallerBase
    {
        [SerializeField] private Player3dView player3dView;
        ...
        {
            // View
            builder.RegisterInstance(player3dView).AsImplementedInterfaces();
