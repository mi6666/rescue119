...
namespace Test.EditModeTest.Model.InGame.Stage
{
    public class StagePawnModelTest
    {
        ...
        {
            var pawn = new GridCollider(1, new Vector2Int(0, 0), new Vector2Int(1, 1));
        ...
        {
            var pawn = new GridCollider(1, new Vector2Int(5, 5), new Vector2Int(3, 3));
            _stagePawnModel.StorePawn(pawn);
        ...
        {
            var pawn1 = new GridCollider(1, new Vector2Int(2, 2), new Vector2Int(2, 2));
            var pawn2 = new GridCollider(2, new Vector2Int(3, 3), new Vector2Int(2, 2));
        ...
        {
            var pawn = new GridCollider(1, new Vector2Int(0, 0), new Vector2Int(2, 2));
            _stagePawnModel.StorePawn(pawn);
